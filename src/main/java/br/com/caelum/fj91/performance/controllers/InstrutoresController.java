...
import br.com.caelum.fj91.performance.services.InstrutorService;
...
public class InstrutoresController {
	...
	public InstrutoresController(InstrutorService instrutorService) {
		this.instrutorService = instrutorService;
	}

	@GetMapping
	public String listar(Model model) {
		model.addAttribute("instrutores", instrutorService.buscarTodosOrdenadosPeloNome());
	...
	public String remover(@PathVariable("id") Long id, RedirectAttributes redirectModel) {
		this.instrutorService.excluirPorId(id);
